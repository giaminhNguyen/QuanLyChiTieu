...
import com.example.assigment_minhngph25430.Adapter.Adapter_loai;
import com.example.assigment_minhngph25430.DAO.DAO_loai;
import com.example.assigment_minhngph25430.DTO.Loai;
...
public class Fragment_LoaiThu extends Fragment implements Adapter_loai.OnActionSuaXoa, View.OnClickListener {
    ...
    public static Fragment_LoaiThu newInstance() {
        Fragment_LoaiThu fragment = new Fragment_LoaiThu();
        return fragment;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        db = new DAO_loai(getActivity(), Database.KH_THU);
        list = new ArrayList<>();
    }
