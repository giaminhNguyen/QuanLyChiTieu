...
import com.example.assigment_minhngph25430.Adapter.Adapter_khoan;
import com.example.assigment_minhngph25430.Adapter.Adapter_spinner;
import com.example.assigment_minhngph25430.DAO.DAO_khoan;
import com.example.assigment_minhngph25430.DAO.DAO_loai;
import com.example.assigment_minhngph25430.DTO.Khoan;
import com.example.assigment_minhngph25430.DbHelper.Database;
import com.example.assigment_minhngph25430.R;
import com.google.android.material.floatingactionbutton.FloatingActionButton;

import java.util.ArrayList;

public class Fragment_KhoanThu extends Fragment implements Adapter_khoan.OnActionSuaXoa, View.OnClickListener {
    ...
    private ArrayList<Khoan> list,list_tam;
    private ArrayList<String> list_ma;
    private Adapter_spinner adapter_spinner;
    private Adapter_khoan adapter;
    private DAO_khoan db;
    private DAO_loai db_thu;
    private AlertDialog.Builder builder;

    public static Fragment_KhoanThu newInstance() {
        Fragment_KhoanThu fragment = new Fragment_KhoanThu();
        return fragment;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        db = new DAO_khoan(getActivity(), Database.KH_THU);
        db_thu = new DAO_loai(getActivity(),Database.KH_THU);
    }
    ...
    private void acitonFloatAdd() {
        ...
        show_hide_float(View.GONE);
        if(list_ma.size() == 0){
            Toast.makeText(getActivity(), "Hãy thêm tạo thêm loại thu", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    public void actionSua(int index) {
        ...
        position = db_thu.getIndex(obj.getMaLoai());
        ...
        khoanTien.setText(String.valueOf(obj.getKhoanTien()));
        //
        ...
        them.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                tien = khoanTien.getText().toString();
                if(check(tien)){
                    ma_loai = ma_loai.substring(0,ma_loai.indexOf("-"));
